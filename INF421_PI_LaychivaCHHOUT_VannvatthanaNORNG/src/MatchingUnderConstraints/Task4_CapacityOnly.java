...
public class Task4_CapacityOnly {
...
//    	instance1Matches();
    ...
    public static void instance1Matches() {
        ...
        /*
         * With capacity only, we assigned the quota of group equal to number of student
         * in that group
         */
    ...
    public static void instance2Matches(int numStudent) {
    	...
    	Group[] sgroup = new Group[] {new Group("A",studentsInGroupA, studentsInGroupA.size()),new Group("B",studentsInGroupB, studentsInGroupB.size())};
	...
	public static void instance3Matches(int numStudent) {
    	 ...
    	 */
    	Group[] sgroup = new Group[] {new Group("A",studentsInGroupA, studentsInGroupA.size()),new Group("B",studentsInGroupB, studentsInGroupB.size())
    			,new Group("C",studentsInGroupC,studentsInGroupC.size()),new Group("D",studentsInGroupD,studentsInGroupD.size())};
    	School s1 = new School("s1", numStudent/4, sgroup);
    	School s2 = new School("s2", numStudent/4, sgroup);
