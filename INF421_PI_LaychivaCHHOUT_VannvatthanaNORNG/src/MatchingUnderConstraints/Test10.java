...
//		}
	...
	public static void instance1Matches() {
		...
		System.out.println("Preference list of school of " + s1.name + " before apply 4/5th algorithm "+s1.preferences);
		 s1.FairRanking();
		 System.out.println("Preference list of school of " + s1.name + " after apply 4/5th algorithm "+s1.preferences);
		 System.out.println("Preference list of school of " + s2.name + " before apply 4/5th algorithm "+s2.preferences);
		 s2.FairRanking();
		 System.out.println("Preference list of school of " + s2.name + " after apply 4/5th algorithm "+s2.preferences);
	...
	public static void instance2Matches(int numStudent) {
		...
		Group[] sgroup = new Group[] { new Group("A", studentsInGroupA, quotaGroup),
				new Group("B", studentsInGroupB,quotaGroup) };
		...
		System.out.println("Preference list of school of " + s1.name + " apply 4/5th algorithm "+s1.preferences);
		 s1.FairRanking();
		 System.out.println("Preference list of school of " + s1.name + " after apply 4/5th algorithm "+s1.preferences);
		 System.out.println("Preference list of school of " + s2.name + " before apply 4/5th algorithm "+s2.preferences);
		 s2.FairRanking();
	...
	public static void instance3Matches(int numStudent) {
		...
		Group[] sgroup = new Group[] { new Group("A", studentsInGroupA, quotaGroup),
				new Group("B", studentsInGroupB, quotaGroup),
				new Group("C", studentsInGroupC, quotaGroup),
				new Group("D", studentsInGroupD, quotaGroup) };
		School s1 = new School("s1", numStudent / 4, sgroup);
		School s2 = new School("s2", numStudent / 4, sgroup);
